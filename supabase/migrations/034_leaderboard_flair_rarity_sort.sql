-- ============================================================
-- Restore dynamic rarity-based flair sorting in get_global_stats
-- Migration 033 added punch card flair support but accidentally
-- reverted to static sort_order. This migration merges both:
--   - Punch Card multi-completion display (from 033)
--   - Dynamic rarity ordering: rarest achievements first (from 025)
--   - Rarity count includes punch card completions (times_completed > 0)
-- ============================================================
            ...
            (
              ...
              FROM (
                SELECT
                  ...
                  -- For Punch Card with multiple completions, show numbered emoji
                  CASE
